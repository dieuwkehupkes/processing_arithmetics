...
languages={
    ...
    'test': OrderedDict([('L1', 50), ('L2', 500), ('L3', 1500), ('L4', 3000), ('L5', 5000), ('L6', 10000), ('L7', 15000), ('L8', 15000), ('L9', 15000), ('L9_left', 15000), ('L9_right', 15000)]),
    'test_small': OrderedDict([('L9_left', 15), ('L9_right', 15), ('L1', 5), ('L2', 5), ('L3', 15), ('L4', 3), ('L5', 5), ('L6', 1), ('L7', 15), ('L8', 15), ('L9', 15)])
}
ds = np.arange(-10,11)
ops = ['+', '-']
