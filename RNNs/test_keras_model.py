...
# define the model
i = Input(shape=(1,), dtype='int32', name='input')                  # input of the model
embeddings = Embedding(10,9, input_length=5)(i)     # embedding layer  
recurrent = GRU(8)(embeddings)
output = Dense(10, activation='softmax', name='output')(recurrent)
